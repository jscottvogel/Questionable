    ...
    constructor(instance, name, models, options = {}) {
        ...
        this.setInternalProperties(internalProperties, {
            ...
            "models": models.map((model) => {
                ...
                model.Model.setInternalProperties(internalProperties, Object.assign(Object.assign({}, model.Model.getInternalProperties(internalProperties)), { "_table": this, "tableName": name }));
                return model;
            }),
            "getIndexes": async () => {
